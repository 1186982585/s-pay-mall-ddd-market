package com.example.test.types.rule01.logic;

import com.example.test.types.rule02.factory.Rule02TradeRuleFactory;
import com.example.types.design.framework.link.model1.AbstractLogicLink;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;

/**
 * @Author cxj
 * @Date 2025/9/10 14:20
 * @Description:
 */
@Slf4j
@Service
public class RuleLogic101 extends AbstractLogicLink<String, Rule02TradeRuleFactory.DynamicContext, String> {
    ...
    public String apply(String requestParameter, Rule02TradeRuleFactory.DynamicContext dynamicContext) throws Exception {
        ...
        return next(requestParameter, dynamicContext);// 或者直接return String
    }
}
