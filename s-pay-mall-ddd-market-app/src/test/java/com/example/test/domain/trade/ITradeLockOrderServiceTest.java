package com.example.test.domain.trade;
...
public class ITradeLockOrderServiceTest {
    ...
    public void test_lockMarketPayOrder() throws Exception {
        ...
        MarketPayOrderEntity marketPayOrderEntityOld = tradeOrderService.queryNoPayMarketOrderByOutTradeNo(userId, outTradeNo);
