...
import com.example.domain.trade.adapter.port.ITradePort;
...
import com.example.types.enums.NotifyTaskHTTPEnumVO;
...
public class TradePort implements ITradePort {
    ...
    public String groupBuyNotify(NotifyTaskEntity notifyTask) throws Exception {
        //从Redis中获取一个分布式锁（RLock），锁的键（lockKey）由 notifyTask 对象提供。
